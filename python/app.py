...
async def hf_stream_generate(prompt, model, tokenizer , max_tokens=256 , temp=0.2, top_p=1.01):
    # Tokenize properly
    ...
    if name not in ['Null' , 'null' , None , 'None']: 
        ...
        if len(context.strip()) < 10:
            ...
            "GREETING LOGIC:\n"
                ...
                "- Respond by politely greeting them back **using their name**. The user's name is: {name}.\n"
